...
def main():
    ...
    hps_t2w2v = utils.get_hparams_from_file(os.path.join(os.path.split(config['ckpt_text2w2v'])[0], 'config.json'))
    h_sr = utils.get_hparams_from_file(os.path.join(os.path.split(config['ckpt_sr'])[0], 'config.json') )
    h_sr48 = utils.get_hparams_from_file(os.path.join(os.path.split(config['ckpt_sr48'])[0], 'config.json') )
    hps_denoiser = utils.get_hparams_from_file(os.path.join(os.path.split(config['denoiser_ckpt'])[0], 'config.json'))
